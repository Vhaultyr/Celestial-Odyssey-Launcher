...
class Widgets:
    ...
    def setup_widgets(self):
        ...
        # NEWS PANEL
        try:
            response = requests.get("https://raw.githubusercontent.com/Vhaultyr/Celestial-Odyssey-Launcher/refs/heads/main/CHANGELOG.md?token=GHSAT0AAAAAAC6G4MPYKGCRJXCN5LLVR4MK2AG3YRQ")
